 ...
 *  USA.
 *
 *  $Id: gpononumodelslist.php,v 1.26 2012/04/18 13:07:47 DK Exp $
 */
...
$pagelimit = (! ConfigHelper::getConfig('phpui.gpon_onumodels_pagelimit') ? $listdata['total'] : ConfigHelper::getConfig('phpui.gpon_onumodels_pagelimit'));
...
$SMARTY->display('gpon/gpononumodelslist.html');
?>
