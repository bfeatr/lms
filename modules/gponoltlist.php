 ...
 *  USA.
 *
 *  $Id: gponoltlist.php,v 1.26 2012/04/18 13:07:47 DK Exp $
 */
...
$pagelimit = (! ConfigHelper::getConfig('phpui.gpon_olt_pagelimit') ? $listdata['total'] : ConfigHelper::getConfig('phpui.gpon_olt_pagelimit'));
...
$SMARTY->display('gpon/gponoltlist.html');
