 ...
 *  USA.
 *
 *  $Id: gpononulist.php,v 1.26 2012/04/18 13:07:47 DK Exp $
 */
...
$pagelimit = (! ConfigHelper::getConfig('phpui.gpon_onu_pagelimit') ? $listdata['total'] : ConfigHelper::getConfig('phpui.gpon_onu_pagelimit'));
...
$SMARTY->display('gpon/gpononulist.html');
